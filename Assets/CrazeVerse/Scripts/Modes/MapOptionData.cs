    ...
    public class MapOptionData
    {
        ...
        public static MapOptionData[] CreateDefaultMaps()
        {
            ...
            return new[]
            {
                ...
                Create("MAP_GOA_ISLAND", "Goa Island Battle", "Island coast inspired", "Sunny coast", true, false, true, false, false, true),
                Create("MAP_BENGALURU_TECH", "Bengaluru Tech Ruins", "Tech district inspired", "Neon ruins", true, false, true, true, false, false),
                Create("MAP_MYSORE_PALACE", "Mysore Palace Night", "Palace inspired", "Royal glow", true, true, false, true, false, false),
                Create("MAP_COORG_MIST", "Coorg Mist Forest", "Hill forest inspired", "Foggy forest", true, true, false, false, true, false),
                Create("MAP_KARNATAKA_VILLAGE", "Karnataka Village Night", "Village inspired", "Night village", true, true, false, false, false, false)
            };
        }

        private static MapOptionData Create(string mapId, string mapName, string regionStyle, string mood, bool supportsGhostHunt, bool supportsBattleRoyale, bool supportsTDM, bool supportsZombie, bool supportsRace)
        {
